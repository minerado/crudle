...
def test_list_with_ge_operator(db):
    ...
    # Act
    items_ge_20 = Item.list(db, price__ge=20)
...
def test_list_with_lt_operator(db):
    ...
    # Act
    cheap_items = Item.list(db, price__lt=25)
...
def test_list_with_le_operator(db):
    ...
    # Act
    items_le_20 = Item.list(db, price__le=20)
...
def test_list_with_ne_operator(db):
    ...
    # Act
    non_red_items = Item.list(db, color__ne="red")
